...
<body style="background-color:black; margin:0px; padding-bottom:50px">
    ...
    @endif
            <div class="card">
            <h2 class="btn-info" style="text-align:center; padding:15px">Add New Movie</h2>
                <div class="card-header">
                <a href="{{ URL::to('all-movies') }}"><button class="btn btn-primary store-related-post btn-sm">View Movie List</button></a>
                   
                </div>
                <div class="card-body" style="height: 100%;">
                <form action = "{{URL::to('post-movie-form')}}" method = "post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="movie_url" class="form-control">
                        </div>
                        <div class="form-group">
        ...
        <div class="form-group">
            <img id="thumbnail" height="300" width="200">
        </div>
        ...
        <div class="form-group">
            <img id="poster" height="200" width="400">
        </div>
