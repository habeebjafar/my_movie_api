...
<form action = "{{URL::to('post-episode-form')}}" method = "post" enctype="multipart/form-data">
    @csrf
  ...
  <div class="form-group">
                            ...
                            <input type="text" name="episode_url" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Episode Download Url :</label>
                            <input type="text" name="episode_download_url" class="form-control">
                        </div>
